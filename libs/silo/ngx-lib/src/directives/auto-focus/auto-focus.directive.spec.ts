...
describe('siloAutoFocus', () => {
  ...
  it('should auto focus self when self is focusable', () => {
    ...
    expect(component.directive.lastFocusElement).toBe(component.selfDiv.nativeElement);
  });

  it('should auto focus first button', () => {
    fixture.detectChanges();
    expect(component.directive.lastFocusElement).toBe(component.button.nativeElement);
  });
  ...
  it('should auto focus first element with id "targetId"', () => {
    ...
    fixture.detectChanges();
    expect(component.directive.lastFocusElement).toBe(component.targetIdDiv.nativeElement);
  });

  it('should auto focus first element with class "targetClass"', () => {
    component.focusChildSelectors = '.targetClass';
    fixture.detectChanges();
    expect(component.directive.lastFocusElement).toBe(component.targetClassDiv.nativeElement);
  });
});
